...
#' @param plot_edgestat Should the thickness of the edges be adjusted according to a particular co-statistic? Defaults to NULL. Possible choices are "weights" for the bi-variate correlation strength, and "edgebetweenness"
