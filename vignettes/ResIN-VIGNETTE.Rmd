...
```{r silent intro, echo=FALSE, warning=FALSE, message=FALSE, fig.width = 7.2, fig.height = 4.5}
...
```{r first ResIN, fig.width = 7.2, fig.height = 4.5}
ResIN_out <- ResIN(Core_Items)
```
...
```{r first ResIN with geom_ploint, fig.width = 7.2, fig.height = 4.5}
...
```{r figure 2a, fig.width = 7.2, fig.height = 4.5}
...
```{r, warning=FALSE, fig.width = 7.2, fig.height = 4.5}
ResIN_out <- ResIN(Core_Items, detect_clusters = TRUE, plot_whichstat = "cluster",
...
```{r, warning=FALSE, message=FALSE, fig.width = 7.2, fig.height = 4.5}
