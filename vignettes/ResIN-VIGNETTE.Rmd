...
# node_x <- ResIN_boots_extract(ResIN_executed, what = "x")

# ResIN_boots_executed <- ResIN_executed
```
...
result <- unlist(search_list(ResIN_executed, what = what))

# Sample data
ResIN_executed <- list(
  a = 1,
  b = list(
    c = data.frame(d = 4, e = 5),
    f = 6
  ),
  g = data.frame(h = 7, i = 8),
  j = list(
    k = 9,
    l = data.frame(m = 10, n = 11, d = 6)
  )
)
